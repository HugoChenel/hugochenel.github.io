...
date: "2025-03-22"
tags: ["Science & Tech"]
excerpt: "Tutorial — Bulk basics. A complete guide to differential gene expression analysis from raw counts using DESeq2."
---
...
<img src="/assets/images/blog/bulk-rna-seq-analysis/DESeq2_model.png" alt="DESeq2 model" style="width:100%; height:auto; border: 1px solid #ccc; border-radius: 2px;">
...
<img src="/assets/images/blog/bulk-rna-seq-analysis/MA.png" alt="MA plot" style="width:100%; height:auto; border: 1px solid #ccc; border-radius: 2px;">
...
<img src="/assets/images/blog/bulk-rna-seq-analysis/Volcano.png" alt="Volcano plot" style="width:100%; height:auto; border: 1px solid #ccc; border-radius: 2px;">
...
- Red dashed lines indicate typical cutoffs: |log2FC| > 1 and adjusted p-value < 0.05.
...
<img src="/assets/images/blog/bulk-rna-seq-analysis/GO1.png" alt="GO enrichment" style="width:100%; height:auto; border: 1px solid #ccc; border-radius: 2px;">
...
<img src="/assets/images/blog/bulk-rna-seq-analysis/GO2.png" alt="GO enrichment comparison" style="width:100%; height:auto; border: 1px solid #ccc; border-radius: 2px;">
...
```
    ...
    [1] pheatmap_1.0.12             ggplot2_3.4.4               org.Hs.eg.db_3.17.0
    [4] AnnotationDbi_1.64.0        clusterProfiler_4.8.3       apeglm_1.22.1
    [7] sva_3.50.0                  BiocParallel_1.34.2         DESeq2_1.40.2
    [10] SummarizedExperiment_1.30.2 Biobase_2.60.0              GenomicRanges_1.52.1
    [13] IRanges_2.34.1              S4Vectors_0.38.2            BiocGenerics_0.46.0
    [16] TCGAbiolinks_2.28.4         tximport_1.28.0

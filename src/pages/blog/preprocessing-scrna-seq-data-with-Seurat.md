...
date: "2024-11-27"
tags: ["Science & Tech"]
excerpt: "Single cell series 1 — quality control, normalisation, clustering and annotation of single-cell RNA-seq data using Seurat."
---
...
We will be using the R packages Seurat ([https://satijalab.org/seurat/](https://satijalab.org/seurat/)).
...
We will analyze data generated from the study: "p53 drives a transcriptional program that elicits a non-cell-autonomous response and alters cell state in vivo" by S.M. Moyer et al., published in PNAS in 2020 ([https://doi.org/10.1073/pnas.2008474117](https://www.pnas.org/doi/full/10.1073/pnas.2008474117)).
